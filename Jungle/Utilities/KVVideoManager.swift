...
extension KVVideoManager {
    ...
    fileprivate func videoCompositionInstructionForTrack(track: AVCompositionTrack, asset: AVAsset, standardSize:CGSize, atTime: CMTime) -> AVMutableVideoCompositionLayerInstruction {
        ...
        if assetTrack.naturalSize.height < assetTrack.naturalSize.width {
            aspectFillRatio = standardSize.height / assetTrack.naturalSize.width
            print("aspectFillRatio: \(aspectFillRatio) | s: \(standardSize.height) | n: \(assetTrack.naturalSize.width)")
        }
        else {
            aspectFillRatio = standardSize.width / assetTrack.naturalSize.width
            print("aspectFillRatio: \(aspectFillRatio)")
        }
