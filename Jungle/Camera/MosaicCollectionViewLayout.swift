...
class MosaicCollectionViewLayout: UICollectionViewFlowLayout {
    ...
    required override init() {
        ...
        self._sectionInset = UIEdgeInsetsMake(3.0, 3.0, 3.0, 3.0)
        self.interItemSpacing = UIEdgeInsetsMake(3.0, 0, 3.0, 0)
        super.init()
    ...
    {
        return CGSize(width: self._widthForSection(section: section), height: 0.0)
    }
