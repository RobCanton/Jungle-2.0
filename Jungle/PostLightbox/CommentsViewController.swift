...
class CommentsViewController:UIViewController, ASTableDelegate, ASTableDataSource {
    ...
    var bottomInsets:CGFloat = 20.0
    
    override func viewDidLoad() {
        super.viewDidLoad()
        
        let b = UIApplication.edgeToEdgeInsets.bottom
        if b > 0 {
            bottomInsets = b
        }
        ...
        commentBarBottomAnchor  = commentBar.bottomAnchor.constraint(equalTo: view.bottomAnchor, constant: -bottomInsets)
...
extension CommentsViewController: KeyboardAccessoryProtocol {
    ...
    @objc func keyboardWillHide(notification:Notification) {
        self.commentBarBottomAnchor?.constant = -bottomInsets
        keyboardHeight = nil
